...
60% Ergo는 오른손 새끼손가락을 반복적으로 뻗고 오른쪽 손목이 바깥쪽으로 꺾이는 동작 때문에 생기는 부담과 피로를 줄이기 위해 만들었습니다. 자주 사용하는 탐색·편집·기호·기능 키를 왼쪽 엄지로 누르는 SpaceFN 레이어에 배치해 오른손의 이동과 부담을 줄이는 것이 목표입니다.
...
- 규칙 1개, manipulator 27개(레이어 제어 1개 + 기능·기호 매핑 26개)
